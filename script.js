...
{  number: 87,
  ...
  {
    number: 6,
    question: "Which of the following was a key feature of the Oyo Empire's political structure?",
    options: ["Centralized power in the Alaafin", "Decentralized power among provincial governors", "Absolute power of the Oyomesi", "Complete autonomy of the Ogboni cult"],
    answer: "Centralized power in the Alaafin"
  },
  {
    number: 7,
    question: "The Ogboni cult served as:",
...
answeredCorrect['phy101'] = Array(courses['phy101'].length).fill(false);
renderQuestions('phy101');
answeredCorrect['phy102'] = Array(courses['phy102'].length).fill(false);
renderQuestions('phy102');
answeredCorrect['phy123'] = Array(courses['phy123'].length).fill(false);
renderQuestions('phy123');
answeredCorrect['phy124'] = Array(courses['phy124'].length).fill(false);
renderQuestions('phy124');
answeredCorrect['cee101'] = Array(courses['cee101'].length).fill(false);
renderQuestions('cee101');
answeredCorrect['sta122'] = Array(courses['sta122'].length).fill(false);
renderQuestions('sta122');
answeredCorrect['gst101'] = Array(courses['gst101'].length).fill(false);
renderQuestions('gst101');
// === AUTH FRONTEND LOGIC ===
